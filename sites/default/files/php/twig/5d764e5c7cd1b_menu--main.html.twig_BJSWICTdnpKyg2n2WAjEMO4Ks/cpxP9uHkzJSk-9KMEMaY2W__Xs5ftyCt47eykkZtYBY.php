...
/* themes/flow2/templates/menu/menu--main.html.twig */
class __TwigTemplate_28d0579e592fd59067f310e4e0363c4442b364da2e02291f170f53f45f93a53c extends \Twig\Template
{
...
";
        // line 60
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->sandbox->ensureToStringAllowed($this->getAttribute($this, "menu_links", [0 => ($context["items"] ?? null), 1 => ($context["attributes"] ?? null), 2 => 0, 3 => ((($context["classes"] ?? null)) ? (($context["classes"] ?? null)) : ([0 => "menu", 1 => ("menu--" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["menu_name"] ?? null)))), 2 => "nav", 3 => "navbar-nav"])), 4 => ((($context["dropdown_classes"] ?? null)) ? (($context["dropdown_classes"] ?? null)) : ([0 => "dropdown-menu"]))], "method")));
        echo "
";
    }
...
$context["loop"], "last", [])) ? ("last") : (""))];
  ...
  ";
    ...
    {
        return "themes/flow2/templates/menu/menu--main.html.twig";
    }
    ...
    {
        return new Source("", "themes/flow2/templates/menu/menu--main.html.twig", "/var/www/html/drupal/themes/flow2/templates/menu/menu--main.html.twig");
    }
}
