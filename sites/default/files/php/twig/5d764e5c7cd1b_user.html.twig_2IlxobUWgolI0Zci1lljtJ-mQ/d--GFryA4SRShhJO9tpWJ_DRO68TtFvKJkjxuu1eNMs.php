...
class __TwigTemplate_3e32d5bcbdc6702e5861fa659efcce4c694d7762326c094bf3746d47c77059ca extends \Twig\Template
{
  ...
  ";
        ...
        // line 29
        echo "  ";
        if ($this->getAttribute(($context["content"] ?? null), "summary", [])) {
            // line 30
            echo "    <div class = \"user-summary\">";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["content"] ?? null), "summary", [])), "html", null, true);
            echo "</div>
  ";
        }
        // line 32
...
";
    ...
    {
        return array (  77 => 32,  71 => 30,  68 => 29,  62 => 27,  60 => 26,  55 => 25,);
    }
    ...
    {
        return new Source("", "themes/mbase/templates/user/user.html.twig", "/var/www/html/drupal/themes/mbase/templates/user/user.html.twig");
    }
}
